...
<body>
  ...
  if ($resultset->num_rows > 0) {
    ...
    echo "<tr><td>" . $row['userid'] . "</td><td>" . $row['username'] . "</td><td>" . $row['cellphone'] . "</td><td>" . $row['email'] . "</td><td>" . $row['registdate'] . "</td><td>" . $row['lastdate'] . "</td><td>" . $row['status'] . "</td><td><a href='user_update.php?id=" . $row['userid'] . "'>수정</a></td><td><a href='user_deleteprocess.php?id=" . $row['userid'] . "'>삭제</a></td></tr>";
    echo "</table>";
  }
  ?>
  <br>
