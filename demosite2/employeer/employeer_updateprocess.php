...
<?php
  ...
  $employeer_photo = $_POST['employeer_photo'];
  ...
  $stmt = $conn->prepare("UPDATE employeers SET employeer_cellphone = ?, employeer_email = ?, employeer_department = ?, employeer_spot = ?  WHERE employeer_id = ?" );
  $stmt->bind_param("sssss", $employeer_cellphone, $employeer_email, $employeer_department, $employeer_spot, $employeer_id);
  $stmt->execute();
  ...
  header('Location: employeer_detailview.php?employeer_id='.$employeer_id);
?>