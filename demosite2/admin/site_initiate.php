...
$dbname = $appname; // toy project의 이름으로 db와 사용자를 생성하도록 한다.

require_once "../util/sysconfig.php"; // 메시지, 유틸리티 함수 등을 include 한다.
...
echo "<a href='../employeer/app_initiate.php'>Confirm and Return to back</a>";
?>